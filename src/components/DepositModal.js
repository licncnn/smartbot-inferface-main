...
import { QuantityModalStep } from './DepositQuantityModalStep';
...
export const DepositModal = (props, ref) => {
    ...
    return (
        <Dialog
            ...
            <DialogTitleWithClose onClose={handleClose}>
                <Typography variant="h1">Deposit now</Typography>
...
export const depositmodalRef = React.createRef();

export const ShowDepositModal = (quantity) => {
    if (quantity) {
        depositmodalRef.current?.setQuantity(quantity)
    }
    depositmodalRef.current?.setIsOpen(true);
}
...
export default React.forwardRef(DepositModal);
