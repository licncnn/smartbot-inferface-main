...
import { QuantityModalStep } from './WithDrawQuantityModalStep';
...
export const WithdrawModal = (props, ref) => {
    ...
    return (
        <Dialog
            ...
            <DialogTitleWithClose onClose={handleClose}>
                <Typography variant="h1">Withdraw now</Typography>
...
export const withdrawmodalRef = React.createRef();

export const ShowWithDrawModal = (quantity) => {
    if (quantity) {
        withdrawmodalRef.current?.setQuantity(quantity)
    }
    withdrawmodalRef.current?.setIsOpen(true);
}
